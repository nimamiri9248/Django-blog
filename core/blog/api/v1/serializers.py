...
class PostSerializer(serializers.ModelSerializer):
    ...
    category = serializers.SlugRelatedField(slug_field='name', read_only=False , many=False , queryset=Category.objects.all())
    ...
    class Meta:
        model = Post
        fields = ( 'id','title', 'image', 'author', 'snippet' , 'content' , 'url' ,'category', 'status')
